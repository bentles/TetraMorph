function Backdrop(dimension, repeats, startcolour)
{
    ...
    //create materials
    this.mat1 = new THREE.MeshPhongMaterial({map: this.text1 ,vertexColors:THREE.FaceColors, side:THREE.BackSide} );
    this.mat2 = new THREE.MeshPhongMaterial({map: this.text2 , vertexColors:THREE.FaceColors, side:THREE.BackSide} );
